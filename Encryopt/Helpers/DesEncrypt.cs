...
namespace Encryopt.Helpers
{
    ...
    {
        public static string DesKey = AppSettings("DesKey", "null");
    ...
    public class DesEncrypt
    {
        ...
        private static byte[] _rgbIV = ASCIIEncoding.ASCII.GetBytes(Constant.DesKey.Insert(0, "_rgbIVToken").Substring(0, 8));
